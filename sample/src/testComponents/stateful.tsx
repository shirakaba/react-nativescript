...
export class GameLoopComponent extends React.Component<
    React.PropsWithChildren<{
        frameRateMs?: number;
        style?: Partial<RNSStyle>;
    }>,
    {}
> {
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(GameLoopManager, {}, null),
            children
        );
    }
}
...
export class Clock extends React.Component<{}, { date: Date }> {
    ...
    render() {
        ...
        return React.createElement("textView", {}, this.state.date.toLocaleTimeString());
    }
}
...
export class ListPickerTest extends React.Component<{}, { selectedLocationIndex: number; selectedWeatherIndex: number }> {
    private readonly weathers: string[][] = [["Rainy"], ["Sunny", "Cloudy", "Rainy", "Snowy"]];
    private readonly locations: string[] = ["The UK", "Every other temperate country"];
    ...
    render() {
        return React.createElement(
            ...
            React.createElement("label", {}, `Locations`),
            ...
            React.createElement("label", {}, `Weathers`),
            ...
            React.createElement(
                "listPicker",
                {
                    ...
                    onSelectedIndexChange: (args) => {
                        this.setState({
                            selectedWeatherIndex: args.object.selectedIndex,
                        });
                    },
                },
                null
