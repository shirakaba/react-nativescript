...
export type LayoutBaseComponentProps<
    E extends NativeScriptLayoutBase = NativeScriptLayoutBase
> = Props /* & typeof LayoutBase.defaultProps */ & Partial<LayoutBaseProps> & CustomLayoutViewComponentProps<E>;

/**
 * Base class for all views that supports children positioning.
 */
export abstract class RCTLayoutBase<
    P extends CustomLayoutViewComponentProps<E>,
    S extends {},
    E extends NativeScriptLayoutBase
> extends RCTCustomLayoutView<P, S, E> {}
