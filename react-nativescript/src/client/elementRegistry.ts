...
export const elementMap: Record<string, InstanceCreator> = {
    ...
    label: () => new Label(), // This one is special! It's an example of the new CustomNodeHierarchyManager pattern.
    ...
    textView: () => new TextView(), // This one is special! It's an example of the new CustomNodeHierarchyManager pattern.
